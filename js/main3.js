...
function setup() {
    ...
    txtNotes = createDiv('<p>58 Indices On The Body: A Reflection on Translations through Language, Technology and Sounds - Selected Indices Soundworks and Musical Pieces w/Sentiment Analysis</p>');
...
//  console.log.txtNotes(values);
  ...
  stroke(77+(153*saScore),106-(106*saScore),255-(255*saScore)); // the sentiment score is mapped to change the color of the visualisation
